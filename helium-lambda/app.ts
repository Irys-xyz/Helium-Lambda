...
export const lambdaHandler = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
    ...
    try {
        // BUNDLR_URL needs to be in the fully qualified form, i.e `https://node1.bundlr.network`.
        // SOLANA_KEY needs to be the full 88 character long private key string, i.e  `9aV2tL9hHM6hyr3QHPfgm5SbYqt4XqNMLE9AtXqAsbcTE1t9ic7vRtf69Ne9A6x7dGcYTa5W8yUysweTEpLgC7mv`
